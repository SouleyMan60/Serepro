    ...
    <div className="relative">
      ...
      >
        ...
        <span className="mr-3 overflow-hidden rounded-full h-11 w-11 flex-shrink-0">
          {photoURL ? (
            ...
            <span
              className="flex items-center justify-center w-full h-full rounded-full font-bold text-white text-base"
      ...
      >
        ...
        <div className="flex items-center gap-3 pb-3 border-b border-gray-100 dark:border-gray-800 mb-1">
          <span className="overflow-hidden rounded-full h-10 w-10 flex-shrink-0">
            {photoURL ? (
              ...
              <span
                className="flex items-center justify-center w-full h-full rounded-full font-bold text-white text-sm"
                style={{ background: "linear-gradient(135deg, #F97316, #16a34a)" }}
              >
                {initiale}
              </span>
        ...
        <button
          ...
          className="flex items-center gap-3 px-3 py-2 mt-2 w-full font-medium text-red-600 rounded-lg group text-theme-sm hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-500/10 transition-colors"
        >
          <svg className="fill-red-500 dark:fill-red-400" width="20" height="20" viewBox="0 0 24 24" fill="none">
